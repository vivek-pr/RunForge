...
func init() {
	...
	utilruntime.Must(runforgev1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "754a26ac.runforge.io",
	...
	if err := (&controller.AIJobReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "AIJob")
		os.Exit(1)
	}
